	...
	while (fgets(line, MAXLINELEN, fp) != NULL&&saveSlot<SAVESLOTS)//each loop reads a copy of save data
	{
		...
		else
		{
			...
			else
			{
				...
				sscanf_s(line, "%d %d %d %d %d %d %d %d %d %d %d %d %d %d %d", &saveData[saveSlot].conditions[0], &saveData[saveSlot].conditions[1], &saveData[saveSlot].conditions[2], &saveData[saveSlot].conditions[3], &saveData[saveSlot].conditions[4], &saveData[saveSlot].conditions[5], &saveData[saveSlot].conditions[6], &saveData[saveSlot].conditions[7], &saveData[saveSlot].conditions[8], &saveData[saveSlot].conditions[9], &saveData[saveSlot].conditions[10], &saveData[saveSlot].conditions[11], &saveData[saveSlot].conditions[12], &saveData[saveSlot].conditions[13], &saveData[saveSlot].conditions[14]);
				fgets(line, MAXLINELEN, fp);//load items
				sscanf_s(line, "%d %d %d %d %d %d %d %d %d %d %d %d", &saveData[saveSlot].inventory[0], &saveData[saveSlot].inventory[1], &saveData[saveSlot].inventory[2], &saveData[saveSlot].inventory[3], &saveData[saveSlot].inventory[4], &saveData[saveSlot].inventory[5], &saveData[saveSlot].inventory[6], &saveData[saveSlot].inventory[7], &saveData[saveSlot].inventory[8], &saveData[saveSlot].inventory[9], &saveData[saveSlot].inventory[10], &saveData[saveSlot].inventory[11]);
